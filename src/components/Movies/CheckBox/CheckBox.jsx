...
export default function CheckBox({ isCheck, handleFilterShorts, firstEnter }) {

  return (
    <div className='search__block'>
      <input type="checkbox" className='search__ckeck' onChange={() => handleFilterShorts()} disabled={firstEnter} />
