...
export default function CheckBox({ isCheck, changeShort, firstEntrance, }) {
  return (
    <label className={`search__label-container ${firstEntrance && 'search__label-container_disabled'}`}>
      <div className='search__input-container'>
        <input type="checkbox" className='search__check' onChange={() => changeShort()} disabled={firstEntrance} />
        <svg className='search__check-svg' width="36" height="20" viewBox="0 0 36 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g id="smalltumb">
            ...
            <circle
              ...
              id="tumb__COLOR:tumbler-on-2" fill="white" cx="26" cy="10" r="8"
            />
          </g>
        </svg>
      </div>
